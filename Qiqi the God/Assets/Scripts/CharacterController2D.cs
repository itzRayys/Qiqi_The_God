...
public class CharacterController2D : MonoBehaviour
{
	...
	public void Move(float move, bool crouch, bool jump, bool dash, bool doubleJump)
	{
		...
		// Double Jump
		if (!m_Grounded && doubleJump && doubleJumpReady)
		{
		...
		if (!m_Grounded && dash && dashReady)
        {
			...
			{
				m_Rigidbody2D.AddForce(new Vector2(m_DashForce * -1, 0f));
			}
			dashReady = false;
		}
